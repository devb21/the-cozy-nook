...
router.post('/login', [
    ...
    console.log("req.body:", req.body); // Make sure redirect is in the request body

    // Check the redirect value in req.body or req.query, set redirectUrl accordingly
    if (req.body.redirect && req.body.redirect.trim() !== "") {
        redirectUrl = req.body.redirect;
    } else if (req.query.redirect && req.query.redirect.trim() !== "") {
    ...
    db.query(query, [username, null], async (err, results) => {
        ...
        try {
            ...
            res.redirect(redirectUrl); // Redirecting to the URL set above
